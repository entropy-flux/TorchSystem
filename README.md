...
You can full a simple training example [here](https://github.com/entropy-flux/cnn-server-example/tree/main) where I train a CNN in the main.py and the training pipeline done in the src folder. 
